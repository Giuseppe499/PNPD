...
def main():
    ...
    plotLists([rreListNPDIT, rreListNPDIT_NM],
                ...
                saveName=f'{grayConfig.prefix}/RRE_NPDITvsNPDIT_NM_IT.pdf', semilogy=True)
    ...
    plotLists([rreListNPDIT, rreListNPDIT_NM],
                ...
                saveName=f'{grayConfig.prefix}/RRE_NPDITvsNPDIT_NM_TIME.pdf', semilogy=True)
    ...
    plotLists([ssimListNPDIT, ssimListNPDIT_NM],
                ...
                saveName=f'{grayConfig.prefix}/SSIM_NPDITvsNPDIT_NM_IT.pdf')
    ...
    plotLists([ssimListNPDIT, ssimListNPDIT_NM],
                ...
                saveName=f'{grayConfig.prefix}/SSIM_NPDITvsNPDIT_NM_TIME.pdf')
    ...
    # with np.load(f'./npz/{grayConfig.prefix}/NPDIT_K.npz') as data:
    #     x1_Kl = data['x1_K']
    ...
    #                 xlabel='Iteration', ylabel='RRE',
    #                 saveName=f'{grayConfig.prefix}/RRE_NPDIT_K_l{lamValues[i]}_IT.pdf', semilogy=True)
    ...
    #                 title=f'RRE NPDIT $k_{{max}}$ = {kMaxValues}, $\lambda$ = {lamValues[i]}',
    #                 xlabel='Time (seconds)', ylabel='RRE',
    #                 saveName=f'{grayConfig.prefix}/RRE_NPDIT_K_l{lamValues[i]}_TIME.pdf', semilogy=True)
    ...
    #                 xlabel='Iteration', ylabel='SSIM',
    #                 saveName=f'{grayConfig.prefix}/SSIM_NPDIT_K_l{lamValues[i]}_IT.pdf')
    ...
    #                 title=f'SSIM NPDIT $k_{{max}}$ = {kMaxValues}, $\lambda$ = {lamValues[i]}',
    #                 xlabel='Time (seconds)', ylabel='SSIM',
    #                 saveName=f'{grayConfig.prefix}/SSIM_NPDIT_K_l{lamValues[i]}_TIME.pdf')
