...
if __name__ == '__main__':
    ...
    np.savez(f"./grayscaleNPD_K.npz", x1_K=x1_K, imRecNPD_K=imRecNPD_K, rreListNPD_K=rreListNPD_K, ssimListNPD_K=ssimListNPD_K, timeListNPD_K=timeListNPD_K, dpStopIndexNPD_K=dpStopIndexNPD_K, kMaxValues=kMaxValues, lamValues=lamValues)
