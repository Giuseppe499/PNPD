...
def main():
    ...
    lamValues = grayConfig.lamValuesPNPD  # TV regularization parameter
    ...
    np.savez(f"./npz/{grayConfig.prefix}/PNPD_K.npz", x1_K=x1_K, imRecPNPD_K=imRecPNPD_K, rreListPNPD_K=rreListPNPD_K, ssimListPNPD_K=ssimListPNPD_K, timeListPNPD_K=timeListPNPD_K, dpStopIndexPNPD_K=dpStopIndexPNPD_K, kMaxValues=kMaxValues, lamValues=lamValues)
