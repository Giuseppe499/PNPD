...
def main():
    ...
    plotLists([rreListNPD, rreListPNPD, rreListNPDIT],
                ...
                saveName=f'{grayConfig.prefix}/RRE_NPDvsPNPDvsNPDIT_IT.pdf', semilogy=True)
    ...
    plotLists([rreListNPD, rreListPNPD, rreListNPDIT],
                ...
                saveName=f'{grayConfig.prefix}/RRE_NPDvsPNPDvsNPDIT_TIME.pdf', semilogy=True)
    ...
    plotLists([ssimListNPD, ssimListPNPD, ssimListNPDIT],
                ...
                saveName=f'{grayConfig.prefix}/SSIM_NPDvsPNPDvsNPDIT_IT.pdf')
    ...
    plotLists([ssimListNPD, ssimListPNPD, ssimListNPDIT],
                ...
                saveName=f'{grayConfig.prefix}/SSIM_NPDvsPNPDvsNPDIT_TIME.pdf')
