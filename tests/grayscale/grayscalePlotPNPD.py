...
def main():
    ...
    plotLists([rreListPNPD, rreListPNPD_NM],
                ...
                saveName=f'{grayConfig.prefix}/RRE_PNPDvsPNPD_NM_IT.pdf', semilogy=True)
    ...
    plotLists([rreListPNPD, rreListPNPD_NM],
                ...
                saveName=f'{grayConfig.prefix}/RRE_PNPDvsPNPD_NM_TIME.pdf', semilogy=True)
    ...
    plotLists([ssimListPNPD, ssimListPNPD_NM],
                ...
                saveName=f'{grayConfig.prefix}/SSIM_PNPDvsPNPD_NM_IT.pdf')
    ...
    plotLists([ssimListPNPD, ssimListPNPD_NM],
                ...
                saveName=f'{grayConfig.prefix}/SSIM_PNPDvsPNPD_NM_TIME.pdf')
    ...
    with np.load(f'./npz/{grayConfig.prefix}/PNPD_K.npz') as data:
        x1_Kl = data['x1_K']
    ...
    for i in range(len(lamValues)):
        ...
        plotLists(rreListPNPD_Kl[i],
                    ...
                    xlabel='Iteration', ylabel='RRE',
                    saveName=f'{grayConfig.prefix}/RRE_PNPD_K_l{lamValues[i]}_IT.pdf', semilogy=True)
        ...
        plotLists(rreListPNPD_Kl[i],
                    ...
                    title=f'RRE PNPD $k_{{max}}$ = {kMaxValues}, $\lambda$ = {lamValues[i]}',
                    xlabel='Time (seconds)', ylabel='RRE',
                    saveName=f'{grayConfig.prefix}/RRE_PNPD_K_l{lamValues[i]}_TIME.pdf', semilogy=True)
        ...
        plotLists(ssimListPNPD_Kl[i],
                    ...
                    xlabel='Iteration', ylabel='SSIM',
                    saveName=f'{grayConfig.prefix}/SSIM_PNPD_K_l{lamValues[i]}_IT.pdf')
        ...
        plotLists(ssimListPNPD_Kl[i],
                    ...
                    title=f'SSIM PNPD $k_{{max}}$ = {kMaxValues}, $\lambda$ = {lamValues[i]}',
                    xlabel='Time (seconds)', ylabel='SSIM',
                    saveName=f'{grayConfig.prefix}/SSIM_PNPD_K_l{lamValues[i]}_TIME.pdf')
