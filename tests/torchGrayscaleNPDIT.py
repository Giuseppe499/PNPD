...
if __name__ == '__main__':
    ...
    t0 = 0
    for i in range(10):
        x0, x1, t0 = torch_NPDIT_step(x0=x0, x1=x1, y0=y0,gradf=gradf,proxhs=proxhs, mulW=mulW, mulWT=mulWT, mulPIn=mulPIn,                           
                           pStep=pStep, dStep=dStep, PReg=PReg, xOrig=image, t0=t0)
    x1.sum().backward()
    print(lam.grad)
